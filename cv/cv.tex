...
\cventry{Sep. 2019--Present}
    ...
    {}
    {\begin{tabular}{@{}lrr@{}}
        \textbf{Cumulative GPA} & 3.706/4.000 & rank 1/38\\
        \textbf{Major GPA} & 3.817/4.000 & rank 1/38\\
    \end{tabular}}
...
\cvline{Apr. 2021--June 2021}{\small
    \textbf{Training:} theoretical learning of quantum chemistry by \textit{Modern Quantum Chemistry}
    \begin{itemize}[itemsep=2pt]
...
\cvline{Aug. 2021--Dec. 2021}{\small
    ...
    \begin{itemize}[itemsep=4pt]
        ...
        \item Build truncated model to perform DFT calculations along the proposed reaction pathway,
        ...
        \begin{itemize}
            ...
            \item MMPBSA free energy approximation to compare population between states, find one mode energetically
            more stable
        \end{itemize}
        \item QM/MM
        \begin{itemize}
...
\cvline{Apr. 2022--Present}{\small
    ...
    the nature of coordinate bond at the heme iron center in cytochrome P450 inhibition
    \begin{itemize}[itemsep=2pt]
