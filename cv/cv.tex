...
\usepackage{fontspec}
\usepackage[scale=0.92,top=0.5cm]{geometry}
\usepackage{makecell}
\usepackage{booktabs}
\usepackage{soul}
...
\settowidth{\hintscolumnwidth}{0000.0--0000.000}
...
\cvline{Coding tools}{Vim, VSCode, Jupyter Lab, Windows Terminal}
