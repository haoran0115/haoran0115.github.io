...
\cvline{Apr. 2021--June. 2021}{\small
    ...
    \begin{itemize}[itemsep=4pt]
        ...
        \begin{itemize}
            \item \ul{Fixed problematic DIIS algorithm} in original group code
        \end{itemize}
    \end{itemize}
}
\cvline{June 2021--Jul. 2021}{\small
...
\cvline{Aug. 2021--Dec. 2021}{\small
    ...
    \begin{itemize}[itemsep=4pt]
        ...
        \begin{itemize}
            ...
            \item Perform MD simulations, check non-bonding interactions, check clusters in trajectory
...
\cvline{April. 2022--Present}{\small
